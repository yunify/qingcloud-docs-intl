	...
	$.getJSON("category.json", function (data){
		...
		$.each(data,function(key,value){
			...
			$.each(value.category,function(k,v){
				...
				child_category += '<div class="column is-4"><a class="card" href="'+href+'" target="_blank"><h5 class="title">'+v.name+'</h5><p class="is-text-small is-text-gray">'+v.content+'</p><p class="is-text-small is-text-gray">Learn more →</p></a></div>';
			});
